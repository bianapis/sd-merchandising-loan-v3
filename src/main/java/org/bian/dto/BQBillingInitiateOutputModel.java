...
/**
 * BQBillingInitiateOutputModel
 */
public class BQBillingInitiateOutputModel   {
  private String billingInstanceReference = null;

  private String billingInitiateActionReference = null;
  ...
  **/
   ...
   * @return billingInitiateActionReference
  **/

  public String getBillingInitiateActionReference() {
    return billingInitiateActionReference;
  }

  public void setBillingInitiateActionReference(String billingInitiateActionReference) {
    this.billingInitiateActionReference = billingInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Billing instance (e.g. initialised, pending, active) 
